...
package io.jclaw.adapter.out.persistence.event;
...
public final class EventCodec {
    ...
    public static Map<String, Object> encode(JclawEvent event) {
        ...
        switch (event) {
            ...
            case JclawEvent.HookFired e -> {
                out.put("hook", e.hook());
                out.put("stage", e.stage());
    ...
    public static Optional<JclawEvent> decode(Map<String, Object> record) {
        ...
        try {
            ...
            return Optional.ofNullable(switch (type) {
                ...
                case "hook.fired" -> new JclawEvent.HookFired(
                        at, run, str(record, "hook"), str(record, "stage"), str(record, "action"));
